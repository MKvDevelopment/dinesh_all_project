...
public class FullPlanWithdrawActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_full_plan_withdraw);
        ...
        //initiate views
        mobile = findViewById(R.id.full_mobile_no);
        withdrawbtn = findViewById(R.id.full_withdraw_money);
        totalReward = findViewById(R.id.full_totalbal);
        notic = findViewById(R.id.full_withdraw_limit);


        //initiate firebase
        firebaseFirestore = FirebaseFirestore.getInstance();
        user_email = FirebaseAuth.getInstance().getCurrentUser().getEmail();
        documentReference = firebaseFirestore.collection("full_time_user").document(user_email);
        ...
        documentReference.addSnapshotListener(new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException e) {
                if (documentSnapshot != null) {
                    ...
                    Toast.makeText(FullPlanWithdrawActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
        });

        DocumentReference dc = firebaseFirestore.collection("Plan").document("Full_Time_Plan");
        ...
        withdrawbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mob.isEmpty() || mob.length() < 10) {
                    Toast.makeText(FullPlanWithdrawActivity.this, "Enter Valid Mobile No.", Toast.LENGTH_LONG).show();
                    return;
                } else {
                    checkPlan(mob, date);
                }
    ...
    private void checkPlan(String mob, String date) {
        ...
        Toast.makeText(FullPlanWithdrawActivity.this, "Please wait", Toast.LENGTH_SHORT).show();
        updateUserBalance();
    }
    ...
    private void sendDataToServer(String mob, String date) {
        ...
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("FullTime_withdraw_list").child(date);
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        if (task.isSuccessful()) {
                            AlertDialog.Builder alertDialog = new AlertDialog.Builder(FullPlanWithdrawActivity.this);
                            ...
                            Toast.makeText(FullPlanWithdrawActivity.this, "Request sent successfully.", Toast.LENGTH_SHORT).show();
                        }
                    }
    ...
    private void setData() {
        ...
        notic.setText("2. In Full time Plan Withdraw limit is Rs. " + withdraw_limit + "/-");
